...
export class TicketService {
  ...
  async create(data: CreateTicketDto): Promise<Ticket> {
    ...
    const ticketsByCpf = await this.ticketRepository.findByCpf(user.cpf, data.eventId);
    const isAllowedBuyToCpf = limitTicketsByCpf(ticketsByCpf, data.numberOfTickets);
